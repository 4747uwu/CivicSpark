          ...
          <div className="w-full px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                {/* Add the Edit Cover button back for authorized users */}
                {isUserAuthorized && (
                  <button 
                    onClick={() => setShowModal(true)}
                    className="bg-black/30 hover:bg-black/50 text-white px-4 py-2 rounded-full flex items-center space-x-2 transition-all border border-white/10"
                  >
